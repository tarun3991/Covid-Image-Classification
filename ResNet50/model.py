...
for i, (tr_idx, val_idx) in enumerate(kf.split(x_train,y_train)):
    ...
    mc_path = '/home/container/tarun/final_dl_work/Resnet50/resnet_models/model'+str(fold_no)+'.h5'
    ...
    csv_logger = CSVLogger('/home/container/tarun/final_dl_work/Resnet50/train_log/training_log'+str(fold_no)+".csv", separator = ",", append=True)
    tensor_board = TensorBoard(log_dir = '/home/container/tarun/final_dl_work/Resnet50/tensorboard_logs/log'+str(fold_no), 
...
#Model Prediction 
path = '/home/container/tarun/final_dl_work/Resnet50/resnet_models/'
prediction = list()
...
plt.savefig("/home/container/tarun/final_dl_work/Resnet50/plots_resnet/ROC_curve.png",dpi=600,format='png')
plt.clf()
...
plt.savefig("/home/container/tarun/final_dl_work/Resnet50/plots_resnet/CM_plot.png",dpi=600,format='png')
plt.clf()
