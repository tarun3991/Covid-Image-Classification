...
for i, (tr_idx, val_idx) in enumerate(kf.split(x_train,y_train)):
    ...
    basemodel = VGG19(include_top=False, weights='imagenet', input_shape=(224,224,3))
    ...
    mc_path = '/home/container/tarun/final_dl_work/VGG-19Model/vgg19_models/model'+str(fold_no)+'.h5'
    ...
    csv_logger = CSVLogger('/home/container/tarun/final_dl_work/VGG-19Model/train_log/training_log'+str(fold_no)+".csv", separator = ",", append=True)
    tensor_board = TensorBoard(log_dir = '/home/container/tarun/final_dl_work/VGG-19Model/tensorboard_logs/log'+str(fold_no), 
...
#Model Prediction 
path = '/home/container/tarun/final_dl_work/VGG-19Model/vgg19_models/'
prediction = list()
...
plt.savefig("/home/container/tarun/final_dl_work/VGG-19Model/plots_vgg19/ROC_VGG19.png",dpi=600,format='png')
plt.clf()
...
plt.savefig("/home/container/tarun/final_dl_work/VGG-19Model/plots_vgg19/CM_VGG19.png",dpi=600,format='png')
plt.clf()
